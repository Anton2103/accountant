...
//         Add support for Block Styles.
	...
	function new_excerpt_more( $more ){
		...
		return '<span> ...</span></br></br><a class="excerpt_more hover-underline-animation" href="'. esc_url( get_permalink($post->ID) ) . '">' . esc_html__( 'Читати далі...', 'accountant' ) . '</a>';
	}
	...
	function extra_user_profile_fields( $user ) { ?>
        <table class="form-table">
            <tr>
                <th><label for="position"><?php esc_html_e("Position", 'accountant'); ?></label></th>
                <td>
                    ...
                    <span class="description"><?php esc_html_e("Please enter your position.", 'accountant'); ?></span>
                </td>
            </tr>
        </table>
	<?php }
